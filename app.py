...
# Import the dashboard (dashboard.py)
...
def main():
    ...
    with st.sidebar:
        ...
        # Add a button to view the patient data and analytics dashboard
        if st.button("View Patient Data and Analytics"):
            # Set session state to indicate the dashboard should be shown
            st.session_state.view_dashboard = True
            # Instead of st.experimental_rerun(), just set a flag to indicate to show the dashboard
            st.session_state.show_dashboard = True

    # Show the prediction form and make prediction
    if 'show_dashboard' not in st.session_state or not st.session_state.show_dashboard:
        # Main Input Section
        with st.container():
    ...
    # If view_dashboard is True, show the dashboard
    if 'show_dashboard' in st.session_state and st.session_state.show_dashboard:
        dashboard.show_dashboard()  # Call the function from dashboard.py to display the dashboard content
